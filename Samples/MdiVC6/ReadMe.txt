========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : MdiVC6
========================================================================


AppWizard が生成した MdiVC6 には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには MdiVC6 を構成している各ファイルの概要説明が含まれています。
...
MdiVC6.h
    ...
    みます） をインクルードし、また CMdiVC6App アプリケーションクラスを宣
    言します。

MdiVC6.cpp
    このファイルは CMdiVC6App アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\MdiVC6.ico
    ...
    ルです。このアイコンはリソース ファイル MdiVC6.rc によってインクルード
    されます。
...
res\Toolbar.bmp
    ...
    リソースエディタで編集し、MdiVC6.rc ファイル内の IDR_MAINFRAME TOOLBAR 配列を
    変更してください。
/////////////////////////////////////////////////////////////////////////////
...
MdiVC6Doc.h, MdiVC6Doc.cpp - ドキュメント
    これらのファイルは CMdiVC6Doc クラスを含みます。特別なドキュメント デ
    ータを付け加えたり、CMdiVC6Doc::Serialize を使ったファイルのセーブや
    ロード機能をインプリメントしたいときはこのファイルを編集してください。

MdiVC6View.h, MdiVC6View.cpp - ビュー
    これらのファイルは CMdiVC6View クラスを含みます。
    CMdiVC6View オブジェクトは CMdiVC6Doc オブジェクトを表示するために
    使います。
res\MdiVC6Doc.ico
    このファイルは CMdiVC6Doc クラスの MDI 子ウィンドウ用アイコンとして使
    われるアイコンファイルです。このアイコンはリソースファイル MdiVC6.rc
    によってインクルードされます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) MdiVC6.pch 
