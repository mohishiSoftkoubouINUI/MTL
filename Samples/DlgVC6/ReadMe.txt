========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : DlgVC6
========================================================================


AppWizard が生成した DlgVC6 には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには DlgVC6 を構成している各ファイルの概要説明が含まれています。
...
DlgVC6.h
    ...
    みます） をインクルードし、また CDlgVC6App アプリケーションクラスを宣
    言します。

DlgVC6.cpp
    このファイルは CDlgVC6App アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\DlgVC6.ico
    ...
    ルです。このアイコンはリソース ファイル DlgVC6.rc によってインクルード
    されます。
...
DlgVC6Dlg.h, DlgVC6Dlg.cpp - ダイアログ
    これらのファイルは CDlgVC6Dlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な DlgVC6.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) DlgVC6.pch 
