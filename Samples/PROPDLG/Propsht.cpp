// propsht.cpp : CModalShapePropSheet クラスのインプリメンテーション
//
...
BEGIN_MESSAGE_MAP(CModalShapePropSheet, CPropertySheet)
	...
	ON_COMMAND(ID_APPLY_NOW, CModalShapePropSheet::OnApplyNow)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
