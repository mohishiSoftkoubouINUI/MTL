...
MTL (MFC on ATL/WTL) 
	ATL/WTL を使用したヘッダファイルのみの MFC です。
...
機能
	CWinApp/CFrameWnd/CView/CDocument など MFC で作成する標準機能のユーザーインターフェースです。
...
備考
	...
	MTL 対応修正後の MFC プロジェクトは、MFC DLL 使用プロジェクトに変更する事で DLL使用 としてコンパイルする事が可能です。
